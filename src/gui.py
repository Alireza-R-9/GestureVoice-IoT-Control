...
if st.session_state.mode_confirmed:
    ...
    if st.session_state.selected_mode == "Voice Control":
        ...
        with st.container():
            st.markdown("<h4 style='color:#4B0082;'>⏯ Playback Controls</h4>", unsafe_allow_html=True)
        ...
        with st.container():
            st.markdown("<h4 style='color:#4B0082;'>🔊 Volume Controls</h4>", unsafe_allow_html=True)
        ...
        # Speed Controls Card
        with st.container():
            st.markdown("<h4 style='color:#4B0082;'>⚡ Speed Controls</h4>", unsafe_allow_html=True)
